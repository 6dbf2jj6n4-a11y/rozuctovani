        ...
        "navigation": [
            ...
            },
            {
                ...
                "items": [
                    ...
                    {
                        "title": _("Plochy bez karty"),
                        "icon": "door_open",
                        "link": reverse_lazy("admin:core_unit_report_bez_karty"),
                    },
                    {
                    ...
                    },
                    {
                        "title": _("Stav odečtů"),
                        "icon": "fact_check",
                        "link": reverse_lazy("admin:core_meter_report_stav_odectu"),
                    },
                    {
